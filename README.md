...
> [!CAUTION]
> Please note this GitHub repository (https://github.com/shokoloko66/secretive-plotter) is the only official source for EpinelPS. **If you bought it from someone, you got scammed. Do not download EpinelPS from other sources.** Download link: https://github.com/shokoloko66/secretive-plotter/releases
